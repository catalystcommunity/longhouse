...
func (s *ProjectService) Register(d *csilrpc.Dispatcher) {
	d.RegisterTyped("project", "ListProjects", csilrpc.Route(s.ListProjects, csil.DecodeHouseScopedListRequest, csil.EncodeProjectList))
	d.RegisterTyped("project", "GetProject", csilrpc.Route(s.GetProject, csil.DecodeProjectGetProjectRequest, csil.EncodeProject))
	d.RegisterTyped("project", "CreateProject", csilrpc.Route(s.CreateProject, csil.DecodeProject, csil.EncodeProject))
	d.RegisterTyped("project", "UpdateProject", csilrpc.Route(s.UpdateProject, csil.DecodeProject, csil.EncodeProject))
	d.RegisterTyped("project", "DeleteProject", csilrpc.Route(s.DeleteProject, csil.DecodeProjectDeleteProjectRequest, csil.EncodeEmptyResponse))
	d.RegisterTyped("project", "ListProjectTasks", csilrpc.Route(s.ListProjectTasks, csil.DecodeProjectScopedListRequest, csil.EncodeTaskList))
	d.RegisterTyped("project", "AddProjectTask", csilrpc.Route(s.AddProjectTask, csil.DecodeProjectTaskOrderRequest, csil.EncodeEmptyResponse))
	d.RegisterTyped("project", "RemoveProjectTask", csilrpc.Route(s.RemoveProjectTask, csil.DecodeProjectTaskRef, csil.EncodeEmptyResponse))
	d.RegisterTyped("project", "SetProjectTaskPosition", csilrpc.Route(s.SetProjectTaskPosition, csil.DecodeProjectTaskOrderRequest, csil.EncodeEmptyResponse))
	...
	d.RegisterTyped("project", "AddProjectMember", csilrpc.Route(s.AddProjectMember, csil.DecodeProjectMemberRef, csil.EncodeEmptyResponse))
	d.RegisterTyped("project", "RemoveProjectMember", csilrpc.Route(s.RemoveProjectMember, csil.DecodeProjectMemberRef, csil.EncodeEmptyResponse))
	...
	d.RegisterTyped("project", "AddProjectOwner", csilrpc.Route(s.AddProjectOwner, csil.DecodeProjectOwnerRef, csil.EncodeEmptyResponse))
	d.RegisterTyped("project", "RemoveProjectOwner", csilrpc.Route(s.RemoveProjectOwner, csil.DecodeProjectOwnerRef, csil.EncodeEmptyResponse))
	...
	d.RegisterTyped("project", "CreateMilestone", csilrpc.Route(s.CreateMilestone, csil.DecodeMilestone, csil.EncodeMilestone))
	d.RegisterTyped("project", "UpdateMilestone", csilrpc.Route(s.UpdateMilestone, csil.DecodeMilestone, csil.EncodeMilestone))
	d.RegisterTyped("project", "DeleteMilestone", csilrpc.Route(s.DeleteMilestone, csil.DecodeProjectDeleteMilestoneRequest, csil.EncodeEmptyResponse))
	d.RegisterTyped("project", "SetProjectVisibility", csilrpc.Route(s.SetProjectVisibility, csil.DecodeSetProjectVisibilityRequest, csil.EncodeProject))
	...
	d.RegisterTyped("project", "PutProjectGrant", csilrpc.Route(s.PutProjectGrant, csil.DecodePutProjectGrantRequest, csil.EncodeEmptyResponse))
	d.RegisterTyped("project", "DeleteProjectGrant", csilrpc.Route(s.DeleteProjectGrant, csil.DecodeProjectGrantRef, csil.EncodeEmptyResponse))
}
