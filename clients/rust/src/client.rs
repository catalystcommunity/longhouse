...
impl<T: Transport> EventClient<T> {
    ...
    pub fn get_calendar_view(&self, req: HouseID) -> Result<CalendarView, ClientError> {
        let csil_resp =
            self.transport
    ...
    pub fn set_calendar_view(&self, req: CalendarView) -> Result<CalendarView, ClientError> {
        let csil_resp =
            self.transport
